...
#Define global methods before class declaration
...
class AboutMethods < EdgeCase::Koan
  ...
  def test_calling_global_methods_with_wrong_number_of_arguments
    exception = assert_raise(ArgumentError) do
      my_global_method
		...
		#Seems to only like a non-quoted section of code, rather than the whole exception message.
  ...
  def method_without_explicit_return
	...
	#Always returns last line evaluated.
  ...
  private :my_private_method
	#the symbol links to a method? Does this provide any benefits? No params could be passed in.
	#Maybe just for get methods. PRIVATE symbol.
  def test_calling_private_methods_without_receiver
    assert_equal "a secret", my_private_method
  end
	
	#Self cannot call a private method? Scope issues here I think.
