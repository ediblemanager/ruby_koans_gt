...
class AboutScope < EdgeCase::Koan
  ...
  def test_nested_string_is_not_the_same_as_the_system_string
    # Even with the same name, you aren't overriding?
    assert_equal false, String == "HI".class
  end

  def test_use_the_prefix_scope_operator_to_force_the_global_scope
    # Double (double) colon means use Base as parent?
  ...
  def test_constants_can_be_looked_up_explicitly
    # const_get allows for getting the CONSTS in a class (or from an instantiated class?)
  ...
  def test_you_can_get_a_list_of_constants_for_any_class_or_module
    ...
    puts "Constants: #{Object.constants.inspect}"
